...
import (
	...
	rice "github.com/firepads"
	"github.com/firepads"
	gonanoid "github.com/firepads"

	"github.com/firepads/storage"
)
...
func main() {
	...
	if database == "" {
		panic("empty DATABASE env, example value: redis://127.0.0.1:27024, badger:/path/to/folder;")
	}
